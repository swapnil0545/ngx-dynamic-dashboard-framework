...
@Component({
  selector: 'app-sidenav-gadgets',
  templateUrl: './sidenav-gadgets.component.html',
  styleUrls: ['./sidenav-gadgets.component.scss'],
})
export class SidenavGadgetsComponent implements OnInit {
  ...
  setupEventListeners() {
    ...
    this.eventService
      .listenForBoardSideGadgetLayoutEvent().subscribe((event) => {
        this.toggleLayout();
      });
